...
$username_er=$email_err = $password_err = $login_err = "";
...
<body class="container">
    ...
    <p>Connectez vous sur le plus Grand resau evernementiel</p> 
    </div>
    <div class="wrapper">
        <h2>Login</h2>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>si vous n'avez pas de compte? <a href="register.php">clickez ici</a>.</p>
        </form>
    </div>
    </div>
</body>
